...
It is updated whenever a new ADR modifies or replaces any part of the projectÍs baseline.
...
Documentation
- /docs structure aligned with Blueprint Layers 0<ETH>6.
...
- Supports ñuse cacheî directive, hybrid SSR + ISR + PPR rendering.
...
- Rust-based incremental bundler with 2<ETH>5* faster builds.
...
- Uses Next 16Ís opt-in cache model for data synchronization.
- Review: Quarterly
- Owner: Cory Morrissey
