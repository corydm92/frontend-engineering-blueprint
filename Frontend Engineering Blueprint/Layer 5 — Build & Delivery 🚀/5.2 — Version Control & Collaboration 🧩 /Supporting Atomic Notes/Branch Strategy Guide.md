...
´ Keep branches short-lived (1<ETH>3 days) to avoid drift (branch lifespan best practices).
...
------------------------------------------------------------
1<ETH>5 engineers (startup) | GitHub Flow
6<ETH>20 engineers (growth stage) | Trunk-Based Development
...
2. Commits and pushes small, frequent changes (1<ETH>3 day lifespan).
...
´ Feature branches: 1<ETH>3 days
´ Fix branches: 1<ETH>3 days
´ Hotfix branches: same day
´ Release branches: 3<ETH>7 days (until deploy)
´ Chore / Docs branches: 1<ETH>2 days
