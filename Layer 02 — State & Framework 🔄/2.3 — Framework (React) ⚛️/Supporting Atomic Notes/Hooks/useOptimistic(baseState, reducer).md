...
useOptimistic replays speculative intent on top of committed state; transitions make it interruptible, but identity and convergence are explicitly the application’s responsibility.