...
Mental Model – defines how Next.js composes applications using Server and Client Components, and how its file-based routing system maps to the React tree.

Rendering and Data Flow – explains how Next.js transforms requests into HTML and RSC payloads, classifies routes, and handles build-time versus runtime rendering.

Code Splitting & Prefetching – covers how Next.js splits bundles by route and layout boundaries, manages dynamic imports, and prefetches assets to optimize delivery.
