...
However, in some cases (like dashboards or internal tools), it’s more efficient to bundle related routes together into one SSR payload and load them eagerly while still maintaining navigation via the router.
