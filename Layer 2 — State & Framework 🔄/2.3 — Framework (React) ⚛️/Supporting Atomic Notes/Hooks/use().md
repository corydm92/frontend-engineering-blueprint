...
Understand what use() does, where it fits in ReactÍs rendering model, and the exact rules that make it safe and predictable.
...
3. Where use() Fits in ReactÍs Render Model

React rendering is synchronous from the componentÍs point of view.
...
From the componentÍs perspective, use() is purely synchronous.
...
- a way to ñpauseî part of a render
