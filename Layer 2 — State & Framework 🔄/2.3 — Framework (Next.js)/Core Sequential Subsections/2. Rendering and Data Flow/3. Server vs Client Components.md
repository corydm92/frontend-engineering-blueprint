...
- Output is serialized as React ñinstructionsî (RSC payload), not browser-ready HTML.
...
- Together they define Next.jsÍs hybrid rendering model „ streaming data from the server while progressively hydrating client interactions.
