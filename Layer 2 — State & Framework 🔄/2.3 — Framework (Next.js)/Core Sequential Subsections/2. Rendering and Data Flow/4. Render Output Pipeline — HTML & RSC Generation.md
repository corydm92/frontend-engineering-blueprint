...
The stream is not pure HTML „ itÍs a structured set of instructions.
...
Instead, theyÍre compiled into static JavaScript bundles and fingerprinted for hydration.
...
------------------------------------------------------------
8. Why ItÍs Still ñStaticî with Client Components
...
In essence:
Next.js doesnÍt stream raw HTML „ it streams structured React Flight data.
