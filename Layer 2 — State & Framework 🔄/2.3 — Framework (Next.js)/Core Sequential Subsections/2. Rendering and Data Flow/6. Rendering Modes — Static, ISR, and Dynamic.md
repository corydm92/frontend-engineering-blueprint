...
Next.js supports three primary rendering modes that determine when and how a routeÍs HTML and RSC payload are generated and cached:
Static Rendering, Incremental Static Regeneration (ISR), and Dynamic Rendering.

Each mode affects when data is fetched, how long itÍs cached, and whether the browser receives prebuilt artifacts or streamed React payloads.
...
- The type of route (static or dynamic URL) doesnÍt dictate rendering mode „ caching and fetch policies do.
