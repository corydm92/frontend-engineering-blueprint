...
- The associated routeÍs JS chunk and RSC payload are fetched in the background.
...
Prefetching runs only in production builds „ itÍs disabled during development for clarity and consistency.
...
- The routeÍs data and server-rendered payload stream in after click.
