...
- Forcing overflow scrolls to “fix” layout issues.
...
<div className="flex flex-wrap"><div className="mr-8 mb-8">…</div></div>
...
Build mobile-first, test wide, and respect the system’s rhythm.
