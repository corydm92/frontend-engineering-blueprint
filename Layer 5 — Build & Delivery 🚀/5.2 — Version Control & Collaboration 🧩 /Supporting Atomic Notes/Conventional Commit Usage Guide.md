...
If your message doesnÍt follow this format, Husky will block the commit.

------------------------------------------------------------
2. From Branch to Commit (Real Example)

Step 1: Create a new branch based on what youÍre doing.
Examples:
...
If your commit fails, youÍll see an error like:
?
...
When youÍre ready to tag a release:
pnpm release
