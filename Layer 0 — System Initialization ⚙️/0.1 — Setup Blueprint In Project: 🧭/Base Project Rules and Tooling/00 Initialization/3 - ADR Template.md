...
- Changes require a new ADR, not edits
- Superseding ADRs must explicitly reference the ADR they replace
...
## Notes
Optional clarifications, follow-ups, or future review signals.
```
</details>
